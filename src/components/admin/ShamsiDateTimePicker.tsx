...
export default function ShamsiDateTimePicker({
  ...
  const availableYears = Array.from({ length: 16 }, (_, i) => 1405 + i);
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`w-full min-h-[44px] px-3.5 py-2 rounded-2xl border text-right transition-all flex items-center justify-between gap-2 cursor-pointer select-none ${isOpen
      ...
      >
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <ChevronLeft
            className={`size-4 text-muted-foreground transition-transform duration-200 ${isOpen ? '-rotate-90 text-primary' : ''
              }`}
          />
        </div>
      </button>
          ...
          <div className="flex items-center justify-between gap-2 pb-3 border-b border-border">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-xl text-xs font-black transition-colors cursor-pointer ${viewMode === 'months'
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-xl text-xs font-black transition-colors cursor-pointer ${viewMode === 'years'
                    ? 'bg-primary text-primary-foreground shadow-xs'
                    : 'bg-muted/60 text-foreground hover:bg-muted'
                  }`}
              >
              ...
              {JALALI_MONTH_NAMES.map((name, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`py-2 px-1 rounded-2xl text-xs font-black transition-all cursor-pointer ${isSelectedMonth
              ...
              {availableYears.map((yr) => {
                ...
                return (
                  <button
                    ...
                    className={`py-2 rounded-2xl text-xs font-black transition-all cursor-pointer ${isSelectedYear
                        ? 'bg-primary text-primary-foreground shadow-sm shadow-primary/20'
                        : 'bg-muted/30 text-foreground hover:bg-muted'
                      }`}
                  >
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="grid grid-cols-7 gap-1 text-center">
                {JALALI_WEEKDAYS.map((wd) => (
                  <span
                    key={wd.full}
                    className={`text-[11px] font-black py-1 select-none ${wd.isWeekend ? 'text-destructive' : 'text-muted-foreground'
                      }`}
                  >
                    {wd.short}
                  </span>
                ...
                {Array.from({ length: daysInMonth }).map((_, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`size-8 rounded-xl text-xs font-black flex items-center justify-center transition-all cursor-pointer relative ${isSelected
            ...
            <div className="flex items-center justify-between gap-1">
              {[0, 15, 30, 45, 59].map((m) => (
                <button
                  ...
                  className={`px-2 py-1 rounded-xl text-[10px] font-black transition-colors cursor-pointer flex-1 text-center ${tempDate.minute === m
